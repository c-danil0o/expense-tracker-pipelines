...
public class UserMapper {
    ...
    public UserDTO toUserDTO(User user) {
        return UserDTO.builder().userId(user.getUserId()).type(user.getType()).funds(user.getFunds()).
                ...
                firstName(user.getFirstName()).lastName(user.getLastName()).country(user.getCountry()).
                birthDate(user.getBirthDate()).registeredAt(user.getRegisteredAt()).gender(user.getGender()).build();
    }
    ...
    public User fromUserDTO(UserDTO userDTO){
        return User.builder().userId(userDTO.getUserId()).firstName(userDTO.getFirstName()).
                ...
                type(userDTO.getType()).password(userDTO.getPassword()).country(userDTO.getCountry()).
                birthDate(userDTO.getBirthDate()).registeredAt(userDTO.getRegisteredAt()).gender(userDTO.getGender()).build();
    }
}
